      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8 relative">
          <div className="relative inline-block mb-2">
            ...
            <svg viewBox="0 0 100 80" className="w-24 h-20 text-primary mx-auto mb-2 drop-shadow-sm">
              <line x1="35" y1="75" x2="65" y2="75" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
              <line x1="45" y1="75" x2="45" y2="10" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
              <line x1="45" y1="10" x2="65" y2="10" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
        ...
        <div className="bg-white/40 backdrop-blur-md rounded-[2.5rem] p-8 border border-white/40 shadow-[0_20px_50px_oklch(0.5_0.15_145/0.15)]">
          <form onSubmit={submit} className="space-y-4">
            {mode === "signup" && (
              <div className="relative group">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-primary font-bold group-focus-within:scale-110 transition-transform">@</span>
                <Input value={username} onChange={e => setUsername(e.target.value)} placeholder="Username" className="pl-11 h-14 bg-white/90 border-transparent focus:border-primary/30 rounded-2xl shadow-sm" />
              </div>
            )}
            <div className="relative group">
              ...
              <Input type="email" required value={email} onChange={e => setEmail(e.target.value)} placeholder="Email" className="pl-11 h-14 bg-white/90 border-transparent focus:border-primary/30 rounded-2xl shadow-sm" />
            </div>
            <div className="relative group">
              ...
              <Input type={show ? "text" : "password"} required value={password} onChange={e => setPassword(e.target.value)} placeholder="Password" className="pl-11 pr-12 h-14 bg-white/90 border-transparent focus:border-primary/30 rounded-2xl shadow-sm" />
          ...
          <div className="relative my-8 text-center">
            ...
            <span className="bg-transparent px-4 text-xs font-black text-primary/60 tracking-widest uppercase">OR</span>
          </div>
        ...
        <p className="text-center text-primary/80 font-bold mt-8 drop-shadow-sm">Guess smart. Win fast. 🌿</p>
      </div>
    </div>
  );
}