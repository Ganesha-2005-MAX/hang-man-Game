...
export function AchievementToast({ title, description, icon, show, onClose }: AchievementToastProps) {
  React.useEffect(() => {
    if (show) {
            ...
            <div className="relative bg-card/40 rounded-[1.4rem] p-4 flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-warning">New Achievement</span>
                </div>
